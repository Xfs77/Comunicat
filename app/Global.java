...
public class Global extends GlobalSettings {
	...
	public void onStart(Application app) {
		...
		Formatters.register(Comunitat.class, new Formatters.SimpleFormatter<Comunitat>() {
			...
			public Comunitat parse(String text, Locale locale) throws java.text.ParseException {
				Comunitat comunitat;
				try {
		...
		Formatters.register(EstatNota.class, new Formatters.SimpleFormatter<EstatNota>() {
			...
			public EstatNota parse(String text, Locale locale) throws java.text.ParseException {
				String t = text;
		...
		Formatters.register(EstatReunio.class, new Formatters.SimpleFormatter<EstatReunio>() {
			...
			public EstatReunio parse(String text, Locale locale) throws java.text.ParseException {
				String t = text;
		...
		Formatters.register(Element.class, new Formatters.SimpleFormatter<Element>() {
			...
			public Element parse(String text, Locale locale) throws java.text.ParseException {
		...
		Formatters.register(Usuari.class, new Formatters.SimpleFormatter<Usuari>() {
			...
			public Usuari parse(String text, Locale locale) throws java.text.ParseException {
		...
		Formatters.register(TipusVei.class, new Formatters.SimpleFormatter<TipusVei>() {
			...
			public TipusVei parse(String text, Locale locale) throws java.text.ParseException {
		...
		Formatters.register(Nota.class, new Formatters.SimpleFormatter<Nota>() {
			...
			public Nota parse(String text, Locale locale) throws java.text.ParseException {
		...
		Formatters.register(MovimentNota.class, new Formatters.SimpleFormatter<MovimentNota>() {
			...
			public MovimentNota parse(String arg1, Locale locale) throws java.text.ParseException {
